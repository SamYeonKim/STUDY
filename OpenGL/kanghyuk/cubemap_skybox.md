...
* 큐브맵 텍스쳐를 이용하여 배경을 그려본다.

* 큐브맵은 6개의 개별 2D 텍스쳐로 구성된 큐브를 포함하는 텍스쳐이다.
* 방향 벡터를 사용하여 인덱싱, 샘플링을 할 수 있다.
...
* fragment shader에서 큐브맵을 사용하려면 `samplerCube` 타입을 사용한다. uv좌표 대신 방향벡터를 사용한다.
...
* `Skybox` 는 전체 환경을 표현하는 6가지 이미지를 가진 대형 큐브맵이다.

# Result

![](image/cubemap_skybox.png)
...
* [widipedia](https://en.wikipedia.org/wiki/Cube_mapping)
* [OGLdev Tutorial](http://ogldev.atspace.co.uk/www/tutorial25/tutorial25.html)