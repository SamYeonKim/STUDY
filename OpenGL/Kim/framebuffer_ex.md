# FrameBuffer_Excercies

* 아래 예제의 흐름은 다음과 같다
    1. 바닥과 큐브를 커스텀 프레임 버퍼에 쓴다.
    2. 새로운 바닥과 큐브를 기본 프레임 버퍼에 쓴다.
    3. 쓰여진 커스텀 프레임 버퍼에 있는 내용의 색상을 반전 시킨 후 `quad`를 이용해서 기본 프레임 버퍼에 쓴다.
    4. 화면에 그린다.

# Result

![](img/framebuffer_ex.png)
