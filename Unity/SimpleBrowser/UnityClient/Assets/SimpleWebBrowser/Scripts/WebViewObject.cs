...
public class WebViewObject : MonoBehaviour
{
    ...
    /* TODO
     * 1. webView에 해당하는 클래스는 무엇인가? = WebBrowser2D
     * 2. webView 멤버 변수 추가
     * 3. Init 함수 구현
     * 4. LoadUrl 함수 구현
     * 5. 테스트
    ...
    public void Init(Callback cb = null, bool transparent = true, string ua = "", Callback err = null, Callback ld = null, bool enableWKWebView = false)
    {
        onJS = cb;
        onError = err;
        onLoaded = ld;
    ...
    public void SetMargins(int left, int top, int right, int bottom)
    {
        ...
        if ( webView == null )
            return;
        webView.SetMargin(left, top, right, bottom);
#endif
    }
