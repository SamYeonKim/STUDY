...
namespace SharedPluginServer
{
 ...
 log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
       ...
       // public App(CefWorker worker, SharedMemServer memServer, SocketServer commServer,bool enableWebRtc)
        ...
        {
            NavigateEvent msg = new NavigateEvent()
            {
                CanGoForward = _mainWorker.CanGoForward(),
                CanGoBack = _mainWorker.CanGoBack(),
                NavigateUrl = url,
...
log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        ...
        static int Main(string[] args)
        {
            ...
            var app = new App(worker, server, inSrv, outSrv);
